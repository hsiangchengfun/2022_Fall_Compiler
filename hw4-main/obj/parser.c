...
{
       0,   132,   132,   147,   151,   156,   161,   166,   169,   174,
     177,   180,   185,   188,   191,   196,   199,   204,   210,   214,
     219,   222,   227,   231,   236,   239,   244,   249,   252,   257,
     260,   265,   268,   271,   274,   278,   281,   286,   292,   295,
     300,   303,   309,   313,   319,   322,   325,   330,   333,   338,
     341,   346,   349,   354,   357,   360,   363,   366,   369,   372,
     378,   381,   386,   389,   394,   397,   400,   403,   406,   409
};
#endif
...
#line 135 "parser.y"
        ...
        root = (Node*)newProgNode( fl ,fc , (yyvsp[-8].text), (yyvsp[-6].IdentListNode), (yyvsp[-3].DeclarNode), (yyvsp[-2].SubDeclarSNode), (yyvsp[-1].CompoundStatementNode), ll, lc );
        // addChild($$,$2);
        
    }
#line 1643 "obj/parser.c"
    break;
