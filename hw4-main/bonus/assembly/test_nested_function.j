...
.end method
    ...
    isub
    istore 0
    invokestatic test_nested_function/tt_1(I)I
.end method
...
.limit stack 50
    ...
    ldc 0.0
    putstatic test_nested_function/a F
    ldc ""
    putstatic test_nested_function/a Ljava/lang/String;
    ldc 0
    putstatic test_nested_function/b I
    ldc 0.0
    putstatic test_nested_function/b F
    ldc ""
    putstatic test_nested_function/b Ljava/lang/String;
    ldc 5
    fneg
    putstatic test_nested_function/b I
    ldc 3
    invokestatic test_nested_function/ss_0(I)I
    ldc 3
    putstatic test_nested_function/a I
