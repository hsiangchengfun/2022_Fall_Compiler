...
.limit stack 50
    ...
    ldc 0.0
    putstatic test_function/a F
    ldc ""
    putstatic test_function/a Ljava/lang/String;
    ldc 0
    putstatic test_function/b I
    ldc 0.0
    putstatic test_function/b F
    ldc ""
    putstatic test_function/b Ljava/lang/String;
    ldc 0.0
    putstatic test_function/c F
    ldc ""
    putstatic test_function/c Ljava/lang/String;
    ldc 3
